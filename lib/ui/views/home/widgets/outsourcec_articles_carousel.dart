...
class OutsourceArtuclesCarousel extends StatefulWidget {
  final HomeViewModel viewModel;
  const OutsourceArtuclesCarousel({super.key, required this.viewModel});

  @override
  State<OutsourceArtuclesCarousel> createState() =>
      _OutsourceArtuclesCarouselState();
}

class _OutsourceArtuclesCarouselState extends State<OutsourceArtuclesCarousel> {
