...
class ConstructionArticlesCarousel extends StatefulWidget {
  final HomeViewModel viewModel;
  const ConstructionArticlesCarousel({super.key, required this.viewModel});

  @override
  State<ConstructionArticlesCarousel> createState() =>
      _ConstructionArticlesCarouselState();
}

class _ConstructionArticlesCarouselState
    extends State<ConstructionArticlesCarousel> {
